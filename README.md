...
<p align="center">
  <img src="https://github.com/user-attachments/assets/6a36d032-e266-4628-932a-b269ee0d60a2" alt="이미지1 설명" width="300" />
</p>

- 사업자 거래 시 사용자가 더욱 효율적으로 원하는 조건의 사업자를 찾을 수 있도록 다양한 필터 기능을 구현했습니다. 이 필터 기능을 통해 사용자는 판매금액, 월 수익, 월 매출을 기준으로 사업자를 검색할 수 있으며, 구체적인 조건에 맞는 검색 결과만 확인할 수 있습니다.
